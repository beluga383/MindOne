...
```bash
curl -fsSL https://raw.githubusercontent.com/beluga383/MindOne/main/scripts/install.sh \
  | sh -s -- --version v1.0.0 --install-dir "$HOME/.local/bin"
```
...
```bash
cargo install --locked --git https://github.com/beluga383/MindOne --tag v1.0.0 mindone-cli
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/beluga383/MindOne/main/scripts/install.sh \
  | sh -s -- --version v1.0.0 --allow-downgrade
```

```powershell
$installer = [scriptblock]::Create((irm https://raw.githubusercontent.com/beluga383/MindOne/main/scripts/install.ps1))
& $installer -Version v1.0.0 -AllowDowngrade
```
