...
本文档是 MindOne v1.0.0 最终版的 CLI 接口规范，全面支撑白皮书中定义的 **双轨制经济模型**、 **强化型本地沙盒**、 **二维信任体系** 以及 **心理学驱动的体验设计**。
...
*架构备注：采用 OAuth 2.0 Device Flow。私钥存入 OS 级安全凭证库。支持向受控服务端发起 TEE 远程证明 (Remote Attestation) 以获取 Enhanced 信任等级。*
