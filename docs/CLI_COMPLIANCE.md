...
| 安装、版本、中文帮助、doctor、卸载无残留 | 当前 `mindone 1.0.0` 已在 macOS arm64、Linux arm64 和 Linux x86_64 用户态完成 release smoke；x86_64 还真实执行 `model recommend --json` 与 `api info --json` | 三个目标通过；Windows Actions 仍待外部运行 |
